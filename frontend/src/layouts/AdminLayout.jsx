                ...
                <div className={`${sidebar ? 'block' : 'hidden'} md:block block w-40 h-screen fixed bg-[#3a3c67] border-t-2 border-[#535684]`}>
                    <ul className="justify-center p-4 py-6 text-white font-semibold flex flex-col">
                        <Link to={'/admin/dashboard'}>
                            <li className={`${location.pathname == '/admin/dashboard' ?'border-l-4 border-white' : '' } p-3 px-4 hover:border-l-4 hover:border-white hover:bg-[#535684] transition-all`}>Dashboard</li>
                        </Link>
                        ...
                        <Link to={'/admin/dashboard/teacher'}>
                            <li className={`${location.pathname == '/admin/dashboard/teacher' ?'border-l-4 border-white' : '' } p-3 px-4 hover:border-l-4 hover:border-white hover:bg-[#535684] transition-all`}>Teachers</li>
                        </Link>
                        <Link to={'/admin/dashboard/student'}>
                            <li className={`${location.pathname == '/admin/dashboard/student' ?'border-l-4 border-white' : '' } p-3 px-4 hover:border-l-4 hover:border-white hover:bg-[#535684] transition-all`}>Students</li>
                        </Link>
                        <Link to={'/admin/dashboard/class'}>
                            <li className={`${location.pathname == '/admin/dashboard/class' ?'border-l-4 border-white' : '' } p-3 px-4 hover:border-l-4 hover:border-white hover:bg-[#535684] transition-all`}>Classes</li>
                        </Link>
                        <Link to={'/admin/dashboard/exam'}>
                            <li className={`${location.pathname == '/admin/dashboard/exam' ?'border-l-4 border-white' : '' } p-3 px-4 hover:border-l-4 hover:border-white hover:bg-[#535684] transition-all`}>Exam</li>
                        </Link>
                    </ul>
                </div>
            </div>
