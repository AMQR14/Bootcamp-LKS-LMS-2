    ...
    return (
        <AdminLayout>
                ...
                <div className="m-6 w-90 text-[#222443] overflow-auto h-fit">
                    ...
                    <form action="" className="gap-6 flex flex-col">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <input type="text" placeholder="Enter description" className="focus:outline-none border-2 border-gray-200 rounded-md p-2"/>
                        </div>
            ...
            ? <Modal>
                <div className="m-6 w-90 text-[#222443] overflow-auto h-fit">
                    <div className="flex font-semibold justify-between items-center mb-6">
                        <p className="text-lg">Edit Class</p>
                        ...
                        <table className="w-full border-[1.6px] border-[#3a3c67]">
                            <thead className="border-[1.6px] border-[#3a3c67] bg-[#7679a5] text-[#3a3e6d]">
                                <tr>
                                    ...
                                    <th className="border-r-[1.6px] border-[#3a3c67] p-2">Description</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="border-r-[1.6px] border-[#3a3c67] p-1">Description</td>
