    ...
    return (
        <AdminLayout>
            ...
            ? <Modal>
                <div className="m-6 w-100 text-[#222443] overflow-auto h-160">
                    <div className="flex font-semibold justify-between items-center mb-6">
                        <p className="text-lg">Create Teacher</p>
                    ...
                    <form action="" className="gap-6 flex flex-col">
                        ...
                        <div className="flex flex-col gap-1">
                            <label htmlFor="" className="font-semibold">NIP:</label>
                            <input type="text" placeholder="Enter nip" className="focus:outline-none border-2 border-gray-200 rounded-md p-2"/>
                        </div>
                        <div className="flex flex-col gap-1">
                            <label htmlFor="" className="font-semibold">NIDN:</label>
                            <input type="text" placeholder="Enter nidn" className="focus:outline-none border-2 border-gray-200 rounded-md p-2"/>
                        </div>
                        <div className="flex flex-col gap-1">
                        ...
                        <div>
                            ...
                            <input name="" id="" className="focus:outline-none border-2 border-gray-200 rounded-md p-2 w-full"/>
                            <div className="flex-wrap mt-2 flex gap-2">
                                <div className="p-2 px-2 w-fit bg-[#62658e] rounded-md text-white">course 1</div>
                                <div className="p-2 px-2 w-fit bg-gray-200 rounded-md ">dasdasdasda</div>
                                <div className="p-2 px-2 w-fit bg-[#62658e] rounded-md text-white">course 2</div>
                                <div className="p-2 px-2 w-fit bg-gray-200 rounded-md ">course 1</div>
                                <div className="p-2 px-2 w-fit bg-gray-200 rounded-md ">dasdasdasda</div>
                                <div className="p-2 px-2 w-fit bg-gray-200 rounded-md ">course 2</div>
                            </div>
                        </div>
            ...
            ? <Modal>
                <div className="m-6 w-100 text-[#222443] overflow-auto h-160">
                    <div className="flex font-semibold justify-between items-center mb-6">
                        <p className="text-lg">Edit Teacher</p>
